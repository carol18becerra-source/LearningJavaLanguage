...
public class App {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * el patron builder es llamado un patron de diseño Factory, es decir, es un patron de 
		 * diseño creacional (para la creacion de objetos).
		 * 
		 * ¿Que ventajas nos aporta?
		 * 
		 * Nos permite crear objetos aunque no tengamos el constructor explicitamente implementado
		 * y ademas cuando vamos a crear un objeto el orden en que utilicemos 
		 * las propiedades o campos de la clase indiferente*/
